...
4. Create a directory inside your web server's root directory for the feeds. Ensure that you (or the user account that will run the script) has access to write to that directory.
5. Edit the config.yaml file. At minimum will need to customize the list of apps for which you want feeds.
